...
int main(void)
{
    ...
    {
        cout << "Invalid Seat Row. Economy Class Seats at VISTARA AIRBUS ALL ECONOMY are ranging from 1A to 12F & 14A to 29F. Thank You.\n";
        exit(1);
    }
    ...
    {
        cout << "Invalid Seat Position. Economy Class Seats at VISTARA AIRBUS ALL ECONOMY are ranging from 1A to 12F & 14A to 29F. Thank You.\n"
             << endl;
        exit(1);
    }
